...
Transparent, versioned AI agent prompts.
...
Each agent prompt includes a changelog table. See individual PROMPT.md files for version history.

## Live Demo

See these agents in action: [peltzel.dev/about](https://peltzel.dev/about)

## Contributing

Want to create an agent? PRs welcome! Use the existing prompts as templates.
